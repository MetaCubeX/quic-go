...
//
//	mockgen -package quic -self_package github.com/metacubex/quic-go -self_package github.com/metacubex/quic-go -destination mock_token_store_test.go github.com/metacubex/quic-go TokenStore
//
