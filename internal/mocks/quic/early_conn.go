...
// Source: github.com/metacubex/quic-go (interfaces: EarlyConnection)
//
// Generated by this command:
//
//	mockgen -typed -build_flags=-tags=gomock -package mockquic -destination quic/early_conn_tmp.go github.com/metacubex/quic-go EarlyConnection
//
...
func (m *MockEarlyConnection) Config() *quic.Config {
	m.ctrl.T.Helper()
