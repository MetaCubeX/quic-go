...
//
//	mockgen -build_flags=-tags=gomock -package quic -self_package github.com/metacubex/quic-go -destination mock_stream_manager_test.go github.com/metacubex/quic-go StreamManager
//
