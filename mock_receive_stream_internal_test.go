...
//
//	mockgen -build_flags=-tags=gomock -package quic -self_package github.com/metacubex/quic-go -destination mock_receive_stream_internal_test.go github.com/metacubex/quic-go ReceiveStreamI
//
