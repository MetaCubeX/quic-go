...
//
//	mockgen -build_flags=-tags=gomock -package quic -self_package github.com/metacubex/quic-go -destination mock_crypto_data_handler_test.go github.com/metacubex/quic-go CryptoDataHandler
//
