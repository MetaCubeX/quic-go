...
//
//	mockgen -package quic -self_package github.com/metacubex/quic-go -self_package github.com/metacubex/quic-go -destination mock_packetconn_test.go net PacketConn
//
